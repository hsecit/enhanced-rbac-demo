package tech.hsecit.enhanced.rbac.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        tech.hsecit.enhanced.rbac.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        tech.hsecit.enhanced.rbac.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        tech.hsecit.enhanced.rbac.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
